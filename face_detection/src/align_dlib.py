...
class AlignDlib:
    ...
    # dlib eye centres, nose tip, mouse coners
    # DEEP_INSIGHT_LANDMARK = [39, 42, 33, 48, 54]
    ...
    def align(self, imgDim, rgbImg, bb=None,
        ...
        print npLandmarks[npLandmarkIndices]
...
if __name__ == '__main__':
    ...
    alin_d = AlignDlib(predictor_path)
    img = dlib.load_rgb_image(args)
    #img = cv2.imread(args)
    img_bounding_box = alin_d.getLargestFaceBoundingBox(img)
    img_landmark = alin_d.findLandmarks(img, img_bounding_box)


    aligned_img = alin_d.align(112, img)
